...
_C.DATASET.TRAIN_CAPTIONS_SET = ''
_C.DATASET.VAL_CAPTIONS_SET = ''
_C.DATASET.TEST_CAPTIONS_SET = ''
_C.DATASET.ROI_SET = ''
_C.DATASET.DATASET_PATH = ''
_C.DATASET.ROOT_PATH = ''
_C.DATASET.IMAGE_SET = ''
...
_C.DATASET.ALIGN_CAPTION_IMG = False
_C.DATASET.USE_PHRASAL_PARAPHRASES = False
_C.DATASET.SMALL = False
_C.DATASET.NEGATIVE_SAMPLING = 'hard'
...
_C.NETWORK.PHRASE_LOSS_WEIGHT = 1.0
_C.NETWORK.ALIGNMENT_LOSS_WEIGHT = 1.0
...
_C.NETWORK.SENTENCE = edict()
_C.NETWORK.SENTENCE.CLASSIFIER_TYPE = "2fc"    # 2fc or 1fc
_C.NETWORK.SENTENCE.CLASSIFIER_HIDDEN_SIZE = 1024
_C.NETWORK.SENTENCE.CLASSIFIER_DROPOUT = 0.1
_C.NETWORK.PHRASE = edict()
_C.NETWORK.PHRASE.CLASSIFIER_TYPE = "2fc"    # 2fc or 1fc
_C.NETWORK.PHRASE.CLASSIFIER_HIDDEN_SIZE = 1024
_C.NETWORK.PHRASE.CLASSIFIER_DROPOUT = 0.1
